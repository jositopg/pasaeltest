...
function ThemesScreen({ themes, onUpdateTheme, onNavigate, showToast }) {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-6 pb-40">
...
function ExamScreen({ config, themes, onFinish, onNavigate, onUpdateThemes }) {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-3 sm:p-4 md:p-6 pb-40">
...
function SettingsScreen({ onNavigate }) {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-slate-950' : 'bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900'} p-4 sm:p-6 pb-40 transition-colors duration-300`}>
      <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
        <div className="flex items-center gap-3">
          <button onClick={() => onNavigate('home')} className="p-2 bg-white/5 hover:bg-white/10 rounded-xl transition-colors">
            <Icons.ChevronLeft />
